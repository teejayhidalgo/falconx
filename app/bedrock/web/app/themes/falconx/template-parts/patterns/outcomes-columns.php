<?php
/**
 * Outcomes Block Patterns Template
 *
 * @package falconx
 */
...
<!-- wp:heading -->
<h2>Mauris consequat tempus:</h2>
<!-- /wp:heading -->

<!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"id":28,"sizeSlug":"large","linkDestination":"none"} -->
<figure class="wp-block-image size-large"><img src="http://falconx.local/app/uploads/2021/07/icon-1.png" alt="" class="wp-image-28"/></figure>
<!-- /wp:image -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"id":25,"width":118,"sizeSlug":"large","linkDestination":"none"} -->
<figure class="wp-block-image size-large is-resized"><img src="http://falconx.local/app/uploads/2021/07/icon-4.png" alt="" class="wp-image-25" width="118"/></figure>
<!-- /wp:image -->
