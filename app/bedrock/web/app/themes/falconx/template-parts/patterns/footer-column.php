<?php
/**
 * Footer Block Patterns Template
 *
 * @package falconx
 */
...
<h3 class="has-text-align-center">Sed congue at tortor vitae placerat rhoncus gravida</h3>
<!-- /wp:heading -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"style":{"color":{"background":"#f47820"}},"className":"is-style-fill"} -->
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link has-background" style="background-color:#f47820">Let's begin</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<figure class="wp-block-image size-large"><img src="http://falconx.local/app/uploads/2021/07/footer_logo-1.png" alt="" class="wp-image-75"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
